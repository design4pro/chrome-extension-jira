...
export const log = (id: string, text: string, ...args: any) => {
    if (debugInfo) {
        args = args || [];
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export const warn = (id: string, text: string, ...args: any) => {
    if (debugError) {
        args = args || [];
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export const error = (id: string, errorObj: any, ...args: any) => {
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const getPrintableError = (errorMessage: string, stackTrace: any, ...args: any) => {
